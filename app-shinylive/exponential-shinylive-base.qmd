...
server <- function(input, output, session) {
  ...
  output$growth_plot <- renderPlot({
    ...
    if (input$growth_continuous == "continuous") {
      ...
      # Use the included pure solver (Euler method style or ode45_pure adjusted)
      # Since the original used 'euler' method for discrete, we simulate it directly:
    ...
    # 2. High-Performance Base-R Plotting
    ...
    # Reference line at N=0 or starting value if r=0
