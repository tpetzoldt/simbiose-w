...
# ==============================================================================
# 3. SHINY SERVER LOGIC (Fast Base-R Version with stacked plots)
# ==============================================================================
server <- function(input, output, session) {
  ...
  output$resource_plot <- renderPlot({
    ...
    res <- ode45_pure(y0, times, resource, parms, atol = 1e-4, rtol = 1e-4)
    
    # Setup a 2-row, 1-column layout for the two state variables (simulating facet_wrap)
    # mar sets margins: c(bottom, left, top, right)
    # oma sets outer margins to perfectly align labels
