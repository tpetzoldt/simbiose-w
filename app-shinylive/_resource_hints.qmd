![](www/blackman_en.svg){width="49%" fig-alt="Graphical representation of the Blackman model."}
![](www/monod_en.svg){width="49%" fig-alt="Graphical representation of the Monod model."}
